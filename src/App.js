          ...
          <form className="add-details" onSubmit={this.addContent}>
            ...
            <div className="input-holder">
              <img
                ...
                alt="password manager"
              />
              <form className="add-details" onsubmit={this.classAdd}>
                <h1 className="detail-heading">Add New Password</h1>
                <div className="input-holder">
                  <img
            ...
            <div className="sub-div2">
              ...
              {isTrue && (
                <ul className="result-containter">
                  {newList.map(eachValue => (
                    <li
                      ...
                      key={eachValue.id}
                    >
                      <p className={`initial ${eachValue.calssAdd}`}>
                      ...
                      <div className="list-container">
                        ...
                        {isShow && <p className="website">{eachValue}</p>}
                      </div>
                      <button
                        type="button"
                        className="del-btn"
